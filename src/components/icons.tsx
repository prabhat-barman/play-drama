...
export function PhoneIcon({size = 20, color = '#e9bcb6'}: IconProps) {
  return (
...
export function TrashIcon({size = 20, color = '#e5e2e1'}: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function HistoryIcon({size = 20, color = '#e5e2e1'}: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
